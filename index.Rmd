...
3. [Scatter Plot: active chw v Contribution (we can come up with a better name later)](#fig4)
...
<a id='fig2'></a>
```{r}
base = ggplot(chw_fp,aes(y=aver_sup_chw)) 
...
<a id='fig3'></a>
```{r}
ggplot(chw_fp, aes(x=ape_contrib, y= avergae_supervision_hf, label=province)) + 
